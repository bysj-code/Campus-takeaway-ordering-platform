		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="用户姓名" prop="user_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['delivery_users_id'] && $check_field('set','user_name')) || (!form_sub['delivery_users_id'] && $check_field('add','user_name'))"></el-input>
				...
				<el-form-item label="用户性别" prop="user_gender">
						...
						v-if="user_group === '管理员' || (form_sub['delivery_users_id'] && $check_field('set','user_gender')) || (!form_sub['delivery_users_id'] && $check_field('add','user_gender'))">
