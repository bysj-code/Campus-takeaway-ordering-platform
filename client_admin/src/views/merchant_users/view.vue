		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="商家姓名" prop="merchant_name">
												<el-input id="merchant_name" v-model="form_sub['merchant_name']" placeholder="请输入商家姓名"
							  v-if="user_group === '管理员' || (form_sub['merchant_users_id'] && $check_field('set','merchant_name')) || (!form_sub['merchant_users_id'] && $check_field('add','merchant_name'))"></el-input>
				...
				<el-form-item label="商家性别" prop="merchant_gender">
								<el-select id="merchant_gender" v-model="form_sub['merchant_gender']"
						v-if="user_group === '管理员' || (form_sub['merchant_users_id'] && $check_field('set','merchant_gender')) || (!form_sub['merchant_users_id'] && $check_field('add','merchant_gender'))">
