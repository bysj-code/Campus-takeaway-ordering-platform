<template>
	<el-main class="bg table_wrap">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/food_orders/table','set') || $check_action('/food_orders/view','set') || $check_action('/food_orders/view','get') || $check_action('/下配送单/table','add') || $check_action('/下配送单/view','add')" >
				...
				<template slot-scope="scope">
					...
					<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="openPayModal(scope.row)" v-if="scope.row.pay_state==='未支付' && (user_group == '管理员' || $check_pay('/food_orders/table'))">
						<span>支付</span>
					</el-button>
				</template>
			</el-table-column>
