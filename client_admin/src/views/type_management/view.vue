	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="美食类型" prop="food_types">
							  ...
							  v-if="user_group === '管理员' || (form['type_management_id'] && $check_field('set','food_types')) || (!form['type_management_id'] && $check_field('add','food_types'))" :disabled="disabledObj['food_types_isDisabled']"></el-input>
