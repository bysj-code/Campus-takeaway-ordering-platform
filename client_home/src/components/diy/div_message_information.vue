<template>
	<view class="diy_details diy_div_message_information">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/message_information/get_obj", {
					message_information_id:this.query.message_information_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["message_information_id"] !==0) {
...
<style scoped>
	.div_message_information_details {}
