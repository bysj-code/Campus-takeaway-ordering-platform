<template>
	<div>
			<view v-if="$check_register_field('add','user_name','/delivery_users/view')" class="col-12 col-md-6">
			<view class="diy_title">
				...
				<view v-if="$check_register_field('add','user_gender','/delivery_users/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					用户性别:
				</text>
