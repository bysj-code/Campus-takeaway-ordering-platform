		...
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','food_pictures')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>美食图片:</span>
						</view>
							<view class="diy_field diy_img">
							<image style="width:100%;height:auto;" :src="$fullUrl(obj['food_pictures'])" mode="widthFix"></image>
						</view>
						</view>
					<view v-if="$check_field('get','food_introduction')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>美食介绍:</span>
						</view>
			...
			<view class="container">
				<view class="row">
					<view class="col">
						<button type="button" class="diy_btn" @click="to_form('/pages/food_orders/edit')" v-if="$check_action('/food_orders/edit','add') || $check_action('/food_orders/edit','set')" >下单</button>
					</view>
				</view>
			</view>
		</view>
