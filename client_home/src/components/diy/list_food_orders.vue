		...
		<view class="food_orders_block box_wrap" >
			<navigator class="item_food_orders box_style" v-for="(o, i) in list"  :key="i" :url="'/pages/food_orders/details?food_orders_id=' + o['food_orders_id']">
					...
					<view class="title" v-if="true">
						...
						<view class="view" v-if="1 && $check_index_field('get','store_name','/food_orders/list')">
					<view class="title" v-if="true">
						<span>店铺名称</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','merchant_users','/food_orders/list')">
					<view class="title" v-if="true">
						<span>商家用户</span>
					</view>
					...
					<view class="title" v-if="true">
						...
						<view class="view" v-if="0 && $check_index_field('get','food_types','/food_orders/list')">
					<view class="title" v-if="true">
						<span>美食类型</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','food_prices','/food_orders/list')">
					<view class="title" v-if="true">
						<span>美食价格</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','student_users','/food_orders/list')">
					<view class="title" v-if="true">
						<span>学生用户</span>
					</view>
							<view class="diy_field time" >
						...
						<view class="view" v-if="0 && $check_index_field('get','student_name','/food_orders/list')">
					<view class="title" v-if="true">
						<span>学生姓名</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','contact_number','/food_orders/list')">
					<view class="title" v-if="true">
						<span>联系电话</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','shipping_address','/food_orders/list')">
					<view class="title" v-if="true">
						<span>收货地址</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','purchase_quantity','/food_orders/list')">
					<view class="title" v-if="true">
						<span>购买数量</span>
					</view>
							<view class="diy_field text" >
						...
						<view class="view" v-if="0 && $check_index_field('get','total_purchase_price','/food_orders/list')">
					<view class="title" v-if="true">
						<span>购买总价</span>
					</view>
							<view class="diy_field text" >
						<span>{{ o["total_purchase_price"] }}</span>
					</view>
						</view>
					...
					<view class="title" v-if="true">
						...
						<view class="view" v-if="1 && $check_index_field('get','order_status','/food_orders/list')">
					<view class="title" v-if="true">
						<span>订单状态</span>
					</view>
							<view class="diy_field text" >
