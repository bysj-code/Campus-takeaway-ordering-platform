<template>
  <view class="page_type_management diy_table diy_table_tml" id="type_management_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="美食类型" name="food_types">
                      <uni-easyinput type="text" v-model="query.food_types" placeholder="美食类型" />
                    </uni-forms-item>
                </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/type_management/view?" v-show="user_group == '管理员' || $check_action('/type_management/table','add') || $check_action('/type_management/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/type_management/table','del') || $check_action('/type_management/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/type_management/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/type_management/table','set') || $check_action('/type_management/view','set') || $check_action('/type_management/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
