          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','food_types') || ($check_field('add','food_types') || $check_field('set','food_types'))" label="美食类型" name="food_types">
                            <uni-easyinput type="text" v-model="form['food_types']" v-if="user_group === '管理员' || (form['type_management_id'] && $check_field('set','food_types')) || (!form['type_management_id'] && $check_field('add','food_types'))" :disabled="disabledObj['food_types_isDisabled']" />
                <!-- 仅查看 -->
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/type_management/upload?'),
