<template>
  <view class="page_merchant_users diy_table diy_table_tml" id="merchant_users_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="店铺名称" name="store_name">
                    ...
                    <uni-forms-item label="商家姓名" name="merchant_name">
                      <uni-easyinput type="text" v-model="query.merchant_name" placeholder="商家姓名" />
                    </uni-forms-item>
                    <uni-forms-item label="商家性别" name="merchant_gender">
                 <uni-data-select placeholder="请选择"
                        v-model="query['merchant_gender']"
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/merchant_users/view?" v-show="user_group == '管理员' || $check_action('/merchant_users/table','add') || $check_action('/merchant_users/view','add')">添加</navigator>
                            ...
                            <span>商家姓名</span>
								...
								<text>
									{{ o["merchant_name"] }}
													...
													<view v-if="0 && $check_field('get','merchant_gender')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>商家性别</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/merchant_users/table','del') || $check_action('/merchant_users/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/merchant_users/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/merchant_users/table','set') || $check_action('/merchant_users/view','set') || $check_action('/merchant_users/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
                                    // 商家性别列表
                list_merchant_gender: [{value:"",text:"全部"}],
        			}
		},
		methods: {
          search() {
