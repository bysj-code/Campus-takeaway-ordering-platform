          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','store_name') || ($check_field('add','store_name') || $check_field('set','store_name'))" label="店铺名称" name="store_name">
                            <uni-easyinput type="text" v-model="form['store_name']" v-if="user_group === '管理员' || (form['merchant_users_id'] && $check_field('set','store_name')) || (!form['merchant_users_id'] && $check_field('add','store_name'))" :disabled="disabledObj['store_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','merchant_name') || ($check_field('add','merchant_name') || $check_field('set','merchant_name'))" label="商家姓名" name="merchant_name">
                            <uni-easyinput type="text" v-model="form['merchant_name']" v-if="user_group === '管理员' || (form['merchant_users_id'] && $check_field('set','merchant_name')) || (!form['merchant_users_id'] && $check_field('add','merchant_name'))" :disabled="disabledObj['merchant_name_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','merchant_name')">
                  {{ form['merchant_name'] }}
                </text>
                          </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','merchant_gender') || ($check_field('add','merchant_gender') || $check_field('set','merchant_gender'))" label="商家性别" name="merchant_gender">
                    <uni-data-select
                  v-model="form.merchant_gender"
                  :localdata="list_merchant_gender"
                  :clear="!disabledObj['merchant_gender_isDisabled']"
                  :disabled="disabledObj['merchant_gender_isDisabled']"
                  v-if="user_group === '管理员' || (form['merchant_users_id'] && $check_field('set','merchant_gender')) || (!form['merchant_users_id'] && $check_field('add','merchant_gender'))"
                ></uni-data-select>
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','merchant_gender')">
                  {{ form['merchant_gender'] }}
                </text>
                  </uni-forms-item>
