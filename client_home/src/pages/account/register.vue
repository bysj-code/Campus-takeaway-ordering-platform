						...
						<view class="register_view">
							<uni-forms class="form_register" :rules="rules" :value="form" ref="form"
								...
								<form_student_users v-if="form.user_group === '学生用户'" @change="handleSubFormChange" :form="form_sub" ></form_student_users>
										<!-- 配送用户 -->
								<form_delivery_users v-if="form.user_group === '配送用户'" @change="handleSubFormChange" :form="form_sub" ></form_delivery_users>
										<!-- 商家用户 -->
								<form_merchant_users v-if="form.user_group === '商家用户'" @change="handleSubFormChange" :form="form_sub" ></form_merchant_users>
...
<script>
	...
	import form_student_users from "@/components/diy/form_student_users";
			/* 配送用户 */
	import form_delivery_users from "@/components/diy/form_delivery_users";
			/* 商家用户 */
	import form_merchant_users from "@/components/diy/form_merchant_users";
