<template>
  <view class="page_delivery_order diy_table diy_table_tml" id="delivery_order_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/delivery_order/view?" v-show="user_group == '管理员' || $check_action('/delivery_order/table','add') || $check_action('/delivery_order/view','add')">添加</navigator>
                            ...
                            <span>订单编号</span>
								...
								<text>
									{{ o["order_number"] }}
													...
													<view v-if="1 && $check_field('get','store_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>店铺名称</span>
                          </view>
								...
								<text>
									{{ o["store_name"] }}
													...
													<view v-if="0 && $check_field('get','merchant_users')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>商家用户</span>
                          </view>
                            ...
                            <span>美食名称</span>
								...
								<text>
									{{ o["food_name"] }}
													...
													<view v-if="0 && $check_field('get','food_types')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>美食类型</span>
                          </view>
								...
								<text>
									{{ o["food_types"] }}
													...
													<view v-if="0 && $check_field('get','food_prices')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>美食价格</span>
                          </view>
								...
								<text>
									{{ o["food_prices"] }}
													...
													<view v-if="0 && $check_field('get','student_users')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>学生用户</span>
                          </view>
											<view class="diy_field diy_uid text">
								<text>
									{{ get_user_student_users(o['student_users']) }}
								</text>
							</view>
										</view>
					</view>
                            ...
                            <span>购买数量</span>
								...
								<text>
									{{ o["purchase_quantity"] }}
													...
													<view v-if="0 && $check_field('get','delivery_users')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>配送用户</span>
                          </view>
											<view class="diy_field diy_uid text">
								<text>
									{{ get_user_delivery_users(o['delivery_users']) }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="1 && $check_field('get','delivery_status')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>配送状态</span>
                          </view>
								...
								<text>
									{{ o["delivery_status"] }}
													...
													<view v-if="0 && $check_field('get','delivery_description')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>配送描述</span>
                          </view>
								...
								<text>
									{{ o["delivery_description"] }}
													...
													<view v-if="0 && $check_field('get','receiving_status')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>收货状态</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/delivery_order/table','del') || $check_action('/delivery_order/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/delivery_order/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/delivery_order/table','set') || $check_action('/delivery_order/view','set') || $check_action('/delivery_order/view','get')" class="btn btn-primary">详情</navigator>
	                                    <!--跨表按钮-->
                                <a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/message_information/view','add')" @click="to_form('/pages/message_information/view',o)">
                      <span>留言</span>
                    </a>
                        					</view>
				</view>
		...
		data() {
			return {
                ...
                list_delivery_status: [{value:"",text:"全部"}],
                                    // 收货状态列表
                list_receiving_status: [{value:"",text:"全部"}],
        			}
		},
		methods: {
          search() {
