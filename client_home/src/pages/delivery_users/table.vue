<template>
  <view class="page_delivery_users diy_table diy_table_tml" id="delivery_users_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/delivery_users/view?" v-show="user_group == '管理员' || $check_action('/delivery_users/table','add') || $check_action('/delivery_users/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/delivery_users/table','del') || $check_action('/delivery_users/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/delivery_users/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/delivery_users/table','set') || $check_action('/delivery_users/view','set') || $check_action('/delivery_users/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
