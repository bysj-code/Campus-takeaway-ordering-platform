	...
	<view class="page_food_information diy_detail diy_detail--new" id="food_information_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					...
					<view v-if="$check_field('get','merchant_users')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>商家用户</span>
							</view>
					...
					<view v-if="$check_field('get','food_types')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>美食类型</span>
							</view>
					...
					<view v-if="$check_field('get','food_prices')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>美食价格</span>
							</view>
					...
					<view v-if="$check_field('get','food_pictures')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>美食图片</span>
							</view>
								<view class="diy_field diy_img">
								<img :src="$fullUrl(obj['food_pictures'])" />
							</view>
							</view>
					</view>
					<view v-if="$check_field('get','food_introduction')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>美食介绍</span>
							</view>
		...
		<view class="warp">
			<view class="container-fluid container-fluid-comment--new">
				<view class="row">
					<view class="col">
									<button type="button" class="btn btn-primary" v-if="$check_action('/food_orders/edit','add')" @click="to_form('/pages/food_orders/edit')">
							<span>下单</span>
						</button>
