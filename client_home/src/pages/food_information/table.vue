				...
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/food_information/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/food_information/table','set') || $check_action('/food_information/view','set') || $check_action('/food_information/view','get')" class="btn btn-primary">详情</navigator>
					                    																		<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/food_orders/view','add')" @click="to_form('/pages/food_orders/view',o)">
									<span>下单</span>
								</a>
																						</view>
			</view>
