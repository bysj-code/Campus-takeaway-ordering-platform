<template>
  <view class="page_message_information diy_table diy_table_tml" id="message_information_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/message_information/view?" v-show="user_group == '管理员' || $check_action('/message_information/table','add') || $check_action('/message_information/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/message_information/table','del') || $check_action('/message_information/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/message_information/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/message_information/table','set') || $check_action('/message_information/view','set') || $check_action('/message_information/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 获取数据地址
				url_get_list: "~/api/message_information/get_list?like=0",
				url_del: "~/api/message_information/del?",
